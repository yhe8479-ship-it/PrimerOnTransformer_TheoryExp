...
def translate(text, max_len):
    run_dir = PROJECT_ROOT / "run" / "translation"
    ...
    print("中文输入:", text)
    print("英文输出:", tgt_tok.decode(output_ids))


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--text", type=str, default="我明天去北京。")
    parser.add_argument("--max_len", type=int, default=80)
    args = parser.parse_args()
    translate(args.text, args.max_len)
